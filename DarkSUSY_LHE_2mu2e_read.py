...
filename = "DarkSUSY_mH_125_mGammaD_0400_cT_200_13TeV_2e2mu-madgraph452_bridge224_events80k.lhe"
f = open(filename, 'r')

if len(filename) >= 77:
	mass_GammaD = getStringBetween(filename, "mGammaD_","_cT")
	lifetime_GammaD = getStringBetween(filename, "_cT_","_13TeV")
	energy = getStringBetween(filename, lifetime_GammaD + "_","TeV_")
...
print "gammaD (mass, lifetime, lifetime legend, mass legend)" 	
print mass_GammaD
...
h_muon_pT_dummy.SetXTitle("p_{T} of Leptons [GeV]")
...
h_muon_pZ_dummy.SetXTitle("|p_{Z}| of Leptons [GeV]")
...
h_muon_Phi_dummy.SetXTitle("#phi of Leptons [rad]")
...
h_muon_p_dummy.SetXTitle("p of Leptons [GeV]")
...
#h_dimuon_m_dummy.SetXTitle("m_{Lepton Jet} [GeV]")
...
#h_dimuon_m_log_dummy.SetXTitle("m_{Lepton Jet} [GeV]")
...
#h_dimuon_m_real_fake_dummy.SetXTitle("m_{Lepton Jet} [GeV]")
...
#h_dimuon_m_real_fake_log_dummy.SetXTitle("m_{Lepton Jet} [GeV]")
...
h_dimuon_m_fake_log_dummy.SetXTitle("Mass of Fake Lepton Jet [GeV]")
...
h_dimuon_m_fake_dummy.SetXTitle("Mass of Fake Lepton Jet [GeV]")
...
h_dielectron_m_fake_log_dummy = ROOT.TH1F("h_dielectron_m_fake_log_dummy", "h_dielectron_m_fake_log_dummy", 1250, 0, 125)
h_dielectron_m_fake_log_dummy.SetYTitle("Fraction of events / 0.1 GeV")
h_dielectron_m_fake_log_dummy.GetYaxis().SetNdivisions(508);
h_dielectron_m_fake_log_dummy.SetTitleOffset(1.4, "Y")
h_dielectron_m_fake_log_dummy.SetXTitle("Mass of Fake ee [GeV]")
h_dielectron_m_fake_log_dummy.SetMaximum( 1 )

h_dielectron_m_fake_log_0 = ROOT.TH1F("h_dielectron_m_fake_log_0", "h_dielectron_m_fake_log_0", 1250, 0, 125)
h_dielectron_m_fake_log_0.SetLineColor(ROOT.kRed)
h_dielectron_m_fake_log_0.SetLineWidth(2)
h_dielectron_m_fake_log_0.SetLineStyle(1)

h_dielectron_m_fake_dummy = ROOT.TH1F("h_dielectron_m_fake_dummy", "h_dielectron_m_fake_dummy", nBins, binMin, binMax)
h_dielectron_m_fake_dummy.SetYTitle("Fraction of events / 1 GeV")
h_dielectron_m_fake_dummy.GetYaxis().SetNdivisions(508);
h_dielectron_m_fake_dummy.SetTitleOffset(1.35, "Y")
h_dielectron_m_fake_dummy.SetXTitle("Mass of Fake ee [GeV]")
h_dielectron_m_fake_dummy.SetMaximum( 1.2 )

h_dielectron_m_fake_0 = ROOT.TH1F("h_dielectron_m_fake_0", "h_dielectron_m_fake_0", nBins, binMin, binMax)
h_dielectron_m_fake_0.SetLineColor(ROOT.kRed)
h_dielectron_m_fake_0.SetLineWidth(2)
h_dielectron_m_fake_0.SetLineStyle(1)
...
h_m1_vs_m2.SetYTitle("m_{#mu#mu} [GeV]")
h_m1_vs_m2.SetTitleOffset(1.3, "Y")
h_m1_vs_m2.SetXTitle("m_{ee} [GeV]")

h_m1_vs_m2_dielectron = ROOT.TH2F("h_m1_vs_m2_dielectron", "h_m1_vs_m2_dielectron", m_bins, m_min, m_max, m_bins, m_min, m_max)
h_m1_vs_m2_dielectron.SetYTitle("m_{1ee} [GeV]")
h_m1_vs_m2_dielectron.SetTitleOffset(1.3, "Y")
h_m1_vs_m2_dielectron.SetXTitle("m_{2ee} [GeV]")
...
h_m1_dielectron = ROOT.TH1F("h_m1_dielectron", "h_m1_dielectron", 101, 0.1, 10.1)
h_m1_dielectron.SetLineColor(ROOT.kRed)
h_m1_dielectron.SetLineWidth(2)
h_m1_dielectron.SetLineStyle(1)

h_m2_dielectron = ROOT.TH1F("h_m2_dielectron", "h_m2_dielectron", 101, 0.1, 10.1)
h_m2_dielectron.SetYTitle("Events / 0.1 GeV")
h_m2_dielectron.SetXTitle("m_{ee} [GeV]")
h_m2_dielectron.SetTitleOffset(1.35, "Y")
h_m2_dielectron.SetLineColor(ROOT.kBlue)
h_m2_dielectron.SetLineWidth(2)
h_m2_dielectron.SetLineStyle(1)
h_m2_dielectron.SetMaximum(110000)
...
h_dimuon_1_pT_dummy.SetXTitle("p_{T} of Lepton Jets [GeV]")
...
h_dimuon_1_pZ_dummy.SetXTitle("|p_{Z}| of Lepton Jets [GeV]")
...
h_dimuon_1_Eta_dummy.SetXTitle("#eta of Lepton Jets")
...
h_dimuon_1_Phi_dummy.SetXTitle("#phi of LeptonJets [rad]")
...
h_dimuon_1_p_dummy.SetXTitle("p of LeptonJets [GeV]")
...
h_dimuon_1_M_dummy.SetXTitle("Mass of LeptonJets [GeV]")
...
h_dielectron_1_pT_dummy = ROOT.TH1F("h_dielectron_1_pT_dummy", "h_dielectron_1_pT_dummy", 100, 0, 100)
h_dielectron_1_pT_dummy.SetYTitle("Fraction of events / 1 GeV")
h_dielectron_1_pT_dummy.SetTitleOffset(1.35, "Y")
h_dielectron_1_pT_dummy.SetXTitle("p_{T} of ee [GeV]")
h_dielectron_1_pT_dummy.SetMaximum( 0.1 )

h_dielectron_1_pZ_dummy = ROOT.TH1F("h_dielectron_1_pZ_dummy", "h_dielectron_1_pZ_dummy", 100, 0, 100)
h_dielectron_1_pZ_dummy.SetYTitle("Fraction of events / 1 GeV")
h_dielectron_1_pZ_dummy.SetTitleOffset(1.35, "Y")
h_dielectron_1_pZ_dummy.SetXTitle("|p_{Z}| of ee [GeV]")
h_dielectron_1_pZ_dummy.SetMaximum( 0.1 )

h_dielectron_1_Eta_dummy = ROOT.TH1F("h_dielectron_1_Eta_dummy", "h_dielectron_1_Eta_dummy",100,-5,5)
h_dielectron_1_Eta_dummy.SetYTitle("Fraction of events / 0.1")
h_dielectron_1_Eta_dummy.SetTitleOffset(1.35, "Y")
h_dielectron_1_Eta_dummy.SetXTitle("#eta of ee")
h_dielectron_1_Eta_dummy.SetMaximum( 0.1 )

h_dielectron_1_Phi_dummy = ROOT.TH1F("h_dielectron_1_Phi_dummy", "h_dielectron_1_Phi_dummy",80,-4,4 )
h_dielectron_1_Phi_dummy.SetYTitle("Fraction of events / 0.1 rad")
h_dielectron_1_Phi_dummy.SetTitleOffset(1.35, "Y")
h_dielectron_1_Phi_dummy.SetXTitle("#phi of ee [rad]")
h_dielectron_1_Phi_dummy.SetMaximum( 0.05 )

h_dielectron_1_p_dummy = ROOT.TH1F("h_dielectron_1_p_dummy", "h_dielectron_1_p_dummy", 100, 0, 100)
h_dielectron_1_p_dummy.SetYTitle("Fraction of events / 1 GeV")
h_dielectron_1_p_dummy.SetTitleOffset(1.35, "Y")
h_dielectron_1_p_dummy.SetXTitle("p of ee [GeV]")
h_dielectron_1_p_dummy.SetMaximum( 0.1 )

h_dielectron_1_M_dummy = ROOT.TH1F("h_dielectron_1_M_dummy", "h_dielectron_1_M_dummy", 50, 0.5, 10.005)
h_dielectron_1_M_dummy.SetYTitle("Fraction of events / 0.2 GeV")
h_dielectron_1_M_dummy.SetTitleOffset(1.35, "Y")
h_dielectron_1_M_dummy.SetXTitle("Mass of ee [GeV]")
h_dielectron_1_M_dummy.SetMaximum( 1.4 )

h_dielectron_1_p = ROOT.TH1F("h_dielectron_1_p", "h_dielectron_1_p", 100, 0, 100)
h_dielectron_1_p.SetLineColor(ROOT.kBlue)
h_dielectron_1_p.SetLineWidth(2)
h_dielectron_1_p.SetLineStyle(1)

h_dielectron_1_M = ROOT.TH1F("h_dielectron_1_M", "h_dielectron_1_M", 500, 0.005, 10.005)
h_dielectron_1_M.SetLineColor(ROOT.kBlue)
h_dielectron_1_M.SetLineWidth(2)
h_dielectron_1_M.SetLineStyle(1)

h_dielectron_1_pT = ROOT.TH1F("h_dielectron_1_pT", "h_dielectron_1_pT", 100, 0, 100)
h_dielectron_1_pT.SetLineColor(ROOT.kBlue)
h_dielectron_1_pT.SetLineWidth(2)
h_dielectron_1_pT.SetLineStyle(1)

h_dielectron_1_pZ = ROOT.TH1F("h_dielectron_1_pZ", "h_dielectron_1_pZ", 100, 0, 100)
h_dielectron_1_pZ.SetLineColor(ROOT.kBlue)
h_dielectron_1_pZ.SetLineWidth(2)
h_dielectron_1_pZ.SetLineStyle(1)

h_dielectron_1_Eta = ROOT.TH1F("h_dielectron_1_Eta", "h_dielectron_1_Eta",100,-5,5)
h_dielectron_1_Eta.SetLineColor(ROOT.kBlue)
h_dielectron_1_Eta.SetLineWidth(2)
h_dielectron_1_Eta.SetLineStyle(1)

h_dielectron_1_Phi = ROOT.TH1F("h_dielectron_1_Phi", "h_dielectron_1_Phi", 80,-4,4)
h_dielectron_1_Phi.SetLineColor(ROOT.kBlue)
h_dielectron_1_Phi.SetLineWidth(2)
h_dielectron_1_Phi.SetLineStyle(1)

h_dielectron_2_p = ROOT.TH1F("h_dielectron_2_p", "h_dielectron_2_p", 100, 0, 100)
h_dielectron_2_p.SetLineColor(ROOT.kRed)
h_dielectron_2_p.SetLineWidth(2)
h_dielectron_2_p.SetLineStyle(1)

h_dielectron_2_pT = ROOT.TH1F("h_dielectron_2_pT", "h_dielectron_2_pT", 100, 0, 100)
h_dielectron_2_pT.SetLineColor(ROOT.kRed)
h_dielectron_2_pT.SetLineWidth(2)
h_dielectron_2_pT.SetLineStyle(1)

h_dielectron_2_pZ = ROOT.TH1F("h_dielectron_2_pZ", "h_dielectron_2_pZ", 100, 0, 100)
h_dielectron_2_pZ.SetLineColor(ROOT.kRed)
h_dielectron_2_pZ.SetLineWidth(2)
h_dielectron_2_pZ.SetLineStyle(1)

h_dielectron_2_Eta = ROOT.TH1F("h_dielectron_2_Eta", "h_dielectron_2_Eta", 100,-5,5)
h_dielectron_2_Eta.SetLineColor(ROOT.kRed)
h_dielectron_2_Eta.SetLineWidth(2)
h_dielectron_2_Eta.SetLineStyle(1)

h_dielectron_2_Phi = ROOT.TH1F("h_dielectron_2_Phi", "h_dielectron_2_Phi", 80,-4,4)
h_dielectron_2_Phi.SetLineColor(ROOT.kRed)
h_dielectron_2_Phi.SetLineWidth(2)
h_dielectron_2_Phi.SetLineStyle(1)
...
##First loop to establish event selection
#nEvents = 0
#isEvent = False
#nEventsOK = 0
...
#                  if abs(IDUP) == electronID:
#                    if IDUP > 0: q = -1
#                    if IDUP < 0: q = 1
#                    ev4 = ROOT.TLorentzVector(PUP1, PUP2, PUP3, PUP4)
#                    electrons.append((q, ev4.Px(), ev4.Py(), ev4.Pz(), ev4.E(), ev4.M(), ev4.Pt(), ev4.Eta(), ev4.Phi(), MOTHUP1   ))
...
for line in f:
	...
	if isEvent == True:
		...
		if nLinesInEvent >= 2:
		  ...
		  if len(neutralinos) == 2 and n1PlotCounter == 0 and len(muons) == 2 and len(electrons) == 2:
		  ...
		  if abs(IDUP) == nDID:
                  ...
                  if len(darkNeutralinos) == 2 and nDPlotCounter == 0 and len(muons) == 2 and len(electrons) == 2:
		    ...
		    h_nD_2_Eta.Fill( getEta(darkNeutralinos[1][3], sqrt( darkNeutralinos[1][1]*darkNeutralinos[1][1] + darkNeutralinos[1][2]*darkNeutralinos[1][2] + darkNeutralinos[1][3]*darkNeutralinos[1][3] )) )
		  ...
		  if len(gammaDs) == 2 and gammaDPlotCounter == 0 and len(muons) == 2 and len(electrons) == 2:
		  ...
		  if len(muons) == 2 and len(electrons) == 2:
		    ...
		    electrons_sorted_pT = sorted(electrons, key=itemgetter(6), reverse=True)
		    electrons = electrons_sorted_pT

		    h_muon_pT_0.Fill( muons[0][6] )
		    h_muon_pT_1.Fill( muons[1][6] )
		    h_muon_pT_2.Fill( electrons[0][6] )
		    h_muon_pT_3.Fill( electrons[1][6] )
		    
		    h_muon_eta_0.Fill( muons[0][7] )
		    h_muon_eta_1.Fill( muons[1][7] )
		    h_muon_eta_2.Fill( electrons[0][7] )
		    h_muon_eta_3.Fill( electrons[1][7] )
		   
		    h_muon_phi_0.Fill( muons[0][8]  )  
		    h_muon_phi_1.Fill( muons[1][8]  )
 		    h_muon_phi_2.Fill( electrons[0][8]  )
		    h_muon_phi_3.Fill( electrons[1][8]  )
		    ...
		    h_muon_p_2.Fill( sqrt( electrons[0][1]*electrons[0][1] + electrons[0][2]*electrons[0][2] + electrons[0][3]*electrons[0][3] )  )
                    h_muon_p_3.Fill( sqrt( electrons[1][1]*electrons[1][1] + electrons[1][2]*electrons[1][2] + electrons[1][3]*electrons[1][3] )  )

                    h_muon_pZ_0.Fill( muons[0][3]  )
                    h_muon_pZ_1.Fill( muons[1][3]  )
                    h_muon_pZ_2.Fill( electrons[0][3]  )
		    h_muon_pZ_3.Fill( electrons[1][3]  )
                    

		    px1 = muons[0][1] + muons[1][1]
		    py1 = muons[0][2] + muons[1][2]
		    pz1 = muons[0][3] + muons[1][3]
		    e1  = muons[0][4] + muons[1][4]
		   
		    px2 = electrons[0][1] + electrons[1][1]
                    py2 = electrons[0][2] + electrons[1][2]
                    pz2 = electrons[0][3] + electrons[1][3]
                    e2  = electrons[0][4] + electrons[1][4] 
...
scaleAxisY(h_nD_2_pT,h_nD_1_pT_dummy)
...
legend.AddEntry(h_muon_pT_2,"1st electron","L")
legend.AddEntry(h_muon_pT_3,"2nd electron","L")
legend.Draw()
info.Draw()
txtHeader.Draw()

cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_pT.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_pT.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_pT.C")
...
legend.AddEntry(h_muon_phi_2,"1st electron","L")
legend.AddEntry(h_muon_phi_3,"2nd electron","L")
legend.Draw()
info.Draw()
txtHeader.Draw()

cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_phi.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_phi.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_phi.C")
...
legend.AddEntry(h_muon_pZ_2,"1st electron","L")
legend.AddEntry(h_muon_pZ_3,"2nd electron","L")
legend.Draw()
info.Draw()
txtHeader.Draw()

cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_pZ.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_pZ.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_pZ.C")
...
legend.AddEntry(h_muon_p_2,"1st electron","L")
legend.AddEntry(h_muon_p_3,"2nd electron","L")
legend.Draw()
info.Draw()
txtHeader.Draw()

cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_p.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_p.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_p.C")
...
legend.AddEntry(h_muon_eta_2,"1st electron","L")
legend.AddEntry(h_muon_eta_3,"2nd electron","L")
legend.Draw()
info.Draw()
txtHeader.Draw()

cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_eta.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_eta.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_leptons_eta.C")
...
#legend.SetTextSize(0.02777778)
#legend.SetMargin(0.13)
#legend.AddEntry(h_dimuon_m_0,"1st dimuon (leading m_{Lepton Jet})","L")
...
#info.Draw()
#txtHeader.Draw()
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m.png")
...
#legend.SetTextSize(0.02777778)
#legend.SetMargin(0.13)
#legend.AddEntry(h_dimuon_m_log_0,"1st dimuon (leading m_{Lepton Jet})","L")
...
#txtHeader.Draw()
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_log.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_log.png")
#cnv.SetLogy(0)
#
...
#txtHeader.Draw()
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_real_fake.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_real_fake.png")
#
...
#txtHeader.Draw()
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_real_fake_log.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_real_fake_log.png")
cnv.SetLogy(0)

h_m1_vs_m2.Draw()
info.Draw()
txtHeader.Draw()
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m1_vs_m2.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m1_vs_m2.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m1_vs_m2.C")
...
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m.C")
cnv.SetLogx(0)

#h_m1_vs_m2_dielectron.Draw()
#info.Draw()
#txtHeader.Draw()
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m1_vs_m2_dielectron.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m1_vs_m2_dielectron.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m1_vs_m2_dielectron.C")
#
#cnv.SetLogx()
#h_m2_dielectron.Draw()
#h_m1_dielectron.Draw("same")
#info.Draw()
#txtHeader.Draw()
#txtHeader.Draw()
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m.C")
#cnv.SetLogx(0)
...
#txtHeader.Draw()
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_fake.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_fake.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_fake.C")
#
...
#txtHeader.Draw()
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_fake_log.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_fake_log.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_m_fake_log.C")
#cnv.SetLogy(0)
#cnv.SetLogx(0)
#
...
legend.SetTextSize(0.02777778)
legend.SetMargin(0.13)
legend.AddEntry(h_dimuon_1_pT,"1st Lepton Jet (leading p_{T})","L")
legend.AddEntry(h_dimuon_2_pT,"2nd Lepton Jet","L")
legend.Draw()
info.Draw()
txtHeader.Draw()


cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_pT.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_pT.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_pT.C")
...
legend.SetTextSize(0.02777778)
legend.SetMargin(0.13)
legend.AddEntry(h_dimuon_1_pZ,"1st Lepton Jet (leading p_{T})","L")
legend.AddEntry(h_dimuon_2_pZ,"2nd Lepton Jet","L")
legend.Draw()
info.Draw()
txtHeader.Draw()

cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_pZ.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_pZ.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_pZ.C")
...
legend.SetTextSize(0.02777778)
legend.SetMargin(0.13)
legend.AddEntry(h_dimuon_1_Eta,"1st Lepton Jet (leading p_{T})","L")
legend.AddEntry(h_dimuon_2_Eta,"2nd Lepton Jet","L")
legend.Draw()
info.Draw()
txtHeader.Draw()


cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_Eta.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_Eta.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_Eta.C")
...
legend.SetTextSize(0.02777778)
legend.SetMargin(0.13)
legend.AddEntry(h_dimuon_1_Phi,"1st Lepton Jet (leading p_{T})","L")
legend.AddEntry(h_dimuon_2_Phi,"2nd Lepton Jet","L")
legend.Draw()
info.Draw()
txtHeader.Draw()


cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_Phi.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_Phi.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_Phi.C")
...
legend.SetTextSize(0.02777778)
legend.SetMargin(0.13)
legend.AddEntry(h_dimuon_1_p,"1st Lepton Jet (leading p_{T})","L")
legend.AddEntry(h_dimuon_2_p,"2nd Lepton Jet","L")
legend.Draw()
info.Draw()
txtHeader.Draw()

cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_p.pdf")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_p.png")
cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_LJ_p.C")

#h_dielectron_m_fake_dummy.Draw()
#h_dielectron_m_fake_0.DrawNormalized("same")
#scaleAxisY(h_dielectron_m_fake_0,h_dielectron_m_fake_dummy)
#
#info.Draw()
#txtHeader.Draw()
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m_fake.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m_fake.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m_fake.C")
#
#h_dielectron_m_fake_log_dummy.Draw()
#cnv.SetLogy()
#cnv.SetLogx()
#h_dielectron_m_fake_log_0.DrawNormalized("same")
##scaleAxisY(h_dielectron_m_fake_log_0,h_dielectron_m_fake_log_dummy)
#
#info.Draw()
#txtHeader.Draw()
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m_fake_log.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m_fake_log.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_m_fake_log.C")
#cnv.SetLogy(0)
#cnv.SetLogx(0)
#
#h_dielectron_1_pT_dummy.Draw()
#h_dielectron_1_pT.DrawNormalized("same")
#h_dielectron_2_pT.DrawNormalized("same")
#scaleAxisY(h_dielectron_2_pT,h_dielectron_1_pT_dummy)
#
#legend = ROOT.TLegend(0.46,0.6744444,0.6955556,0.7644444)
#legend.SetFillColor(ROOT.kWhite)
#legend.SetFillStyle(0)
...
#legend.SetTextSize(0.02777778)
#legend.SetMargin(0.13)
#legend.AddEntry(h_dielectron_1_pT,"1st ee (leading p_{T})","L")
#legend.AddEntry(h_dielectron_2_pT,"2nd ee","L")
#legend.Draw()
#info.Draw()
#txtHeader.Draw()
#
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_pT.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_pT.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_pT.C")
#
#h_dielectron_1_pZ_dummy.Draw()
##plotOverflow(h_dielectron_1_pZ)
##plotOverflow(h_dielectron_2_pZ)
#h_dielectron_1_pZ.DrawNormalized("same")
#h_dielectron_2_pZ.DrawNormalized("same")
#scaleAxisY(h_dielectron_2_pZ,h_dielectron_1_pZ_dummy)
#legend = ROOT.TLegend(0.46,0.6744444,0.6955556,0.7644444)
#legend.SetFillColor(ROOT.kWhite)
#legend.SetFillStyle(0)
#legend.SetBorderSize(0)
...
#legend.SetTextSize(0.02777778)
#legend.SetMargin(0.13)
#legend.AddEntry(h_dielectron_1_pZ,"1st ee (leading p_{T})","L")
#legend.AddEntry(h_dielectron_2_pZ,"2nd ee","L")
#legend.Draw()
#info.Draw()
#txtHeader.Draw()
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_pZ.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_pZ.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_pZ.C")
#
#h_dielectron_1_Eta_dummy.Draw()
#h_dielectron_1_Eta.DrawNormalized("same")
#h_dielectron_2_Eta.DrawNormalized("same")
#scaleAxisY(h_dielectron_1_Eta,h_dielectron_1_Eta_dummy)
#
#legend = ROOT.TLegend(0.46,0.6744444,0.6955556,0.7644444)
#legend.SetFillColor(ROOT.kWhite)
#legend.SetFillStyle(0)
...
#legend.SetTextSize(0.02777778)
#legend.SetMargin(0.13)
#legend.AddEntry(h_dielectron_1_Eta,"1st ee (leading p_{T})","L")
#legend.AddEntry(h_dielectron_2_Eta,"2nd ee","L")
#legend.Draw()
#info.Draw()
#txtHeader.Draw()
#
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_Eta.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_Eta.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_Eta.C")
#
#h_dielectron_1_Phi_dummy.Draw()
#h_dielectron_1_Phi.DrawNormalized("same")
#h_dielectron_2_Phi.DrawNormalized("same")
#scaleAxisY(h_dielectron_1_Phi,h_dielectron_1_Phi_dummy)
#
#legend = ROOT.TLegend(0.46,0.6744444,0.6955556,0.7644444)
#legend.SetFillColor(ROOT.kWhite)
#legend.SetFillStyle(0)
...
#legend.SetTextSize(0.02777778)
#legend.SetMargin(0.13)
#legend.AddEntry(h_dielectron_1_Phi,"1st ee (leading p_{T})","L")
#legend.AddEntry(h_dielectron_2_Phi,"2nd ee","L")
#legend.Draw()
#info.Draw()
#txtHeader.Draw()
#
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_Phi.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_Phi.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_Phi.C")
#
#h_dielectron_1_p_dummy.Draw()
#plotOverflow(h_dielectron_1_p)
#plotOverflow(h_dielectron_2_p)
#scaleAxisY(h_dielectron_2_p,h_dielectron_1_p_dummy)
#
#legend = ROOT.TLegend(0.46,0.6744444,0.6955556,0.7644444)
#legend.SetFillColor(ROOT.kWhite)
#legend.SetFillStyle(0)
...
#legend.SetTextSize(0.02777778)
#legend.SetMargin(0.13)
#legend.AddEntry(h_dielectron_1_p,"1st ee (leading p_{T})","L")
#legend.AddEntry(h_dielectron_2_p,"2nd ee","L")
#legend.Draw()
#info.Draw()
#txtHeader.Draw()
#
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_p.pdf")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_p.png")
#cnv.SaveAs("DarkSusy_mH_125_mGammaD_" + mass_GammaD + "_cT_"+ lifetime_GammaD + "_LHE_dielectron_p.C")
#
