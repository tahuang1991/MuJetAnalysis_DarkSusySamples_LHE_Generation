...
//=========  (Tue Oct 25 15:48:02 2016) by ROOT version5.32/04
   ...
   cnv->Range(-10.625,-0.01863435,51.875,0.1247068);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1146729);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06342082);
   h_gammaD_1_cT->SetBinContent(2,0.02344339);
   h_gammaD_1_cT->SetBinContent(3,0.008764579);
   h_gammaD_1_cT->SetBinContent(4,0.003210926);
   h_gammaD_1_cT->SetBinContent(5,0.001160284);
   h_gammaD_1_cT->SetBinContent(6,0.0007171202);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06370718);
   h_gammaD_2_cT->SetBinContent(2,0.02341492);
   h_gammaD_2_cT->SetBinContent(3,0.008584598);
   h_gammaD_2_cT->SetBinContent(4,0.003148021);
   h_gammaD_2_cT->SetBinContent(5,0.001145284);
   h_gammaD_2_cT->SetBinContent(6,0.0006380581);
