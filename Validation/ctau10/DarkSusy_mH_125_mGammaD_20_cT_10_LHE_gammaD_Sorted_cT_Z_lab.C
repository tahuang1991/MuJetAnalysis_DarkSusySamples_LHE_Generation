...
//=========  (Tue Oct 25 15:48:02 2016) by ROOT version5.32/04
   ...
   cnv->Range(-10.625,-0.01331801,51.875,0.0891282);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(0.08195696);
   ...
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.04393976);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.02415759);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.01512438);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.009856124);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.006922146);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,0.03446013);
   ...
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.04553165);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.02491392);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.0146481);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.008977215);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.005929114);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,0.02657975);
